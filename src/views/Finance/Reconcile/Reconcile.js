...
const Reconcile = () => {
  ...
  //     setWithdrawalsTableData((prev) => prev.map((r) => (r.id === row.id ? { ...r, withdrawal: value, deposit: value ? '0' : '' } : r)));
                                          ...
                                          <input
                                            ...
                                            onChange={(e) => {
                                              ...
                                              setWithdrawalsTableErrors((prev) => {
                                                ...
                                                newErrors[index] = {
                                                  ...newErrors[index],
                                                  voucherDate: !date ? 'Voucher Date is required' : '',
                                                };
                                                return newErrors;
                                              });
                                            }}
                                          ...
                                          <input
                                            ...
                                            onChange={(e) => {
                                              ...
                                              setWithdrawalsTableErrors((prev) => {
                                                ...
                                                newErrors[index] = {
                                                  ...newErrors[index],
                                                  chequeDate: !date ? 'Cheque Date is required' : ''
                                                };
                                                return newErrors;
                                              });
                                            }}
