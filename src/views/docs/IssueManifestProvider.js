  ...
  const getAllIssueManifestProviderById = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        const transformedKitDetails = editMimData.issueManifestProviderDetailsVOs.reduce((acc, detail) => {
      ...
      <div style={{ maxWidth: 1060 }} className="ml-auto me-auto">
        <div className="card w-full p-6 bg-base-100 shadow-xl" style={{ padding: '20px' }}>
          ...
          {errors.sender && (
            ...
            <div className="col-lg-3 col-md-6 mb-2">
              <label className="label">
                <span className={'label-text text-base-content '}>Amount In Words:</span>
              </label>
            </div>
            <div className="col-lg-3 col-md-6 mb-2">
              <textarea
