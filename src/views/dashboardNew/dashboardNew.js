                ...
                <TableBody>
                    {gstrData.map((row, index) => (
                        ...
                        >
                            ...
                            <TableCell sx={{ py: 1, textAlign: 'center', fontWeight: 600, fontSize: '0.9rem' }}>{row.invoiceValue.toLocaleString('en-IN')}</TableCell>
...
const DashboardNew = () => {
    ...
    const financialData = [
        { title: 'Revenue', monthly: totalOrderYear, yearly: totalOrderYear },
        { title: 'Cost', monthly: totalCostYear, yearly: totalCostYear },
        { title: 'Accounts Receivable', monthly: 0, yearly: 0 },
        { title: 'Accounts Payable', monthly: 0, yearly: 0 }
    ];
