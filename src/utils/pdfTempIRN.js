      ...
      <DialogContent>
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: '14px' }}>
              <div style={{ display: 'flex', marginBottom: '6px' }}>
                <span style={{ width: '110px', fontWeight: '500' }}>Invoice</span>
                <span>: <strong>{row.vid}</strong></span>
              </div>

              <div style={{ display: 'flex', marginBottom: '6px' }}>
                <span style={{ width: '110px', fontWeight: '500' }}>Credit Date</span>
                <span>: <strong>{row.vdate ? dayjs(row.vdate).format('DD-MM-YYYY') : 'N/A'}</strong></span>
              </div>

              <div style={{ display: 'flex' }}>
                <span style={{ width: '110px', fontWeight: '500' }}>Credit No</span>
                <span>: <strong>{row.docId}</strong></span>
              </div>
            </div>
          </div>
          {/* <!-- Details Section --> */}
          ...
          >
            ...
            >
              {parseFloat(row.totalInvAmountBc).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </span>
          </div>
          ...
          >
            <div className="d-flex justify-content-center">
              <div className="d-flex justify-content-between mb-3">
                ...
                <div>
                  <strong>Credit Date: {row.vdate ? dayjs(row.vdate).format('DD-MM-YYYY') : 'N/A'}</strong>
                </div>
                <div>
                  <strong>Credit No: {row.docId}</strong>
                </div>
              </div>
            </div>
            <div className="d-flex justify-content-center">
